...
client.on('message', async (msg) => {
  ...
  if(msg.content.startsWith('!createReactionRole') && msg.member.hasPermission('ADMINISTRATOR')){
    ...
    if(args.length == 3){
      ...
      .setTitle('👋 » Vérification de votre compte discord')
      .setDescription("Pour accèder à notre discord, vous devez cliquer sur la réaction (✅) qui ce trouve sous ce message.\nSi cela ne fonctionne pas merci de contacter un membre de l'équipe adminsitrative !");
